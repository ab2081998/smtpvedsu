...
# DEFAULT HTML TEMPLATE (Tight Spacing with <br>)
DEFAULT_TEMPLATE = """Hi {Name},<br><br>
I hope this email finds you well.<br><br>
Write your message here...<br><br>
<div style="text-align: left; margin-top: 10px; color: #555555; line-height: 1.4;">
...
def build_bulletproof_html(raw_html_or_text):
    ...
    # Clean redundant empty tags generated by Quill/Rich editors
    formatted_content = re.sub(r'<p>\s*<br\s*/?>\s*</p>', '<br>', formatted_content)
...
<head>
    ...
    <style>
        body {{ font-family: Arial, sans-serif; font-size: 14px; color: #222222; line-height: 1.4; margin: 0; padding: 15px; text-align: left; }}
        p {{ margin: 0 0 4px 0 !important; padding: 0 !important; line-height: 1.4 !important; text-align: left; }}
        div {{ margin: 0; padding: 0; text-align: left; }}
        h1, h2, h3, h4 {{ color: #111111; margin-top: 10px; margin-bottom: 8px; text-align: left; }}
        ul, ol {{ margin-top: 5px; margin-bottom: 10px; padding-left: 20px; text-align: left; }}
        li {{ margin-bottom: 4px; line-height: 1.4; text-align: left; }}
        a {{ color: #0066cc; text-decoration: underline; }}
        b, strong {{ font-weight: bold; }}
        i, em {{ font-style: italic; }}
    </style>
</head>
<body style="text-align: left; line-height: 1.4;">
